...
Eq8 = -Q + 1+eta_i/2*((In+I_ss)/(In_lg+I_ss)-1)^2+...
    eta_i*((In+I_ss)/(In_lg+I_ss)-1)*(In+I_ss)/(In_lg+I_ss)-...
    betta*Lambda_ld*eta_i*((In_ld+I_ss)/(In+I_ss)-1)...
...
System_of_Eq = [Eq1; Eq2; Eq3; Eq4; Eq5;...
             ...
             EqF1; EqF2; EqF3; EqF5; EqF6; EqF7 ;EqF8];
