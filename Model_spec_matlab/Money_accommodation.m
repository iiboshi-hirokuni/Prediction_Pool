...
monetary_accommodation = 0;  % on =1, off =0
...
%%  Endogenous Variables (35)  %2014/08/10 î—êØèCê≥
% Y_t = [c_t; lambda_t; w_t; b_t; Et_r_E_t1; q_t; n_t; r_k_t; u_t; ...
 Y_t = [c_t; lambda_t; w_t;  q_t;  r_k_t; u_t; ...   
%      Et_r_n_t1;    %%  2014/08/12 î—êØ í«â¡
     mc_t; pi_t; pi_t_lg1; pi_t_lg2; ...
     y_t; i_t; k_t; r_n_t; y_star_t; ...
     z_b_t; z_g_t; z_w_t; z_p_t; z_nu_t; z_r_t; z_z_t; z_psi_t; ...
     z_star_t; l_t; ...
%       Et_c_t1; Et_lambda_t1; Et_w_t1;   Et_pi_t1; Et_i_t1; ...
       Et_c_t1; Et_lambda_t1; Et_w_t1; Et_q_t1; Et_r_k_t1; Et_pi_t1; Et_i_t1; ...
     Et_z_b_t1; Et_z_psi_t1; Et_z_star_t1];

%% Endogenous Variables(lagged) (35)  %2014/08/12 î—êØèCê≥
% Y_ta = [c_ta; lambda_ta; w_ta; b_ta; Et_r_E_t1a; q_ta; n_ta; r_k_ta; u_ta; ...
Y_ta = [c_ta; lambda_ta; w_ta; q_ta;  r_k_ta; u_ta; ...
%      Et_r_n_t1a;    %%  2014/08/12 î—êØ í«â¡
     mc_ta; pi_ta; pi_t_lg1a; pi_t_lg2a; ...
     y_ta; i_ta; k_ta; r_n_ta; y_star_ta; ...
     z_b_ta; z_g_ta; z_w_ta; z_p_ta; z_nu_ta; z_r_ta; z_z_ta; z_psi_ta; ...
     z_star_ta; l_ta; ...
%       Et_c_t1a; Et_lambda_t1a; Et_w_t1a;  Et_pi_t1a; Et_i_t1a; ...
...
% Eta_t = [eta_c; eta_lambda; eta_w; eta_q; eta_r_k; eta_pi; eta_i; eta_z_b; eta_z_psi; eta_z_star; eta_r]; %2014/08/12 î—êØèCê≥

% Exogenous Shock Variables
%Epsilon_t = [epsilon_b; epsilon_g; epsilon_w; epsilon_p; epsilon_nu; ... %2014/08/10íÜë∫èCê≥
 %    epsilon_r; epsilon_z; epsilon_psi; epsilon_efp; epsilon_nw];    %2014/08/10íÜë∫èCê≥
...
%Eq_S4 = -b_t + (1+lambda_i)/(1+lambda_i-n_k)*(q_t+k_t)+... %2014/08/10íÜë∫èCê≥
%        (1-(1+lambda_i)/(1+lambda_i-n_k))*n_t;

%Eq_S5 = -Et_r_E_t1 + (1-(1-delta)/r_E/psi)*Et_r_k_t1+...   %2014/08/10íÜë∫èCê≥
%        ((1-delta)/r_E/psi)*Et_q_t1 - q_t - Et_z_psi_t1;

% Eq_S5 = -r_n_t + (1-(1-delta)/r_n/psi)*r_k_t+...   %2014/08/10Å@î—êØèCê≥
%         ((1-delta)/r_n/psi)*q_t - q_ta - z_psi_t;

% Eq_S5 = -Et_r_n_t1 + (1-(1-delta)/r_n/psi)*Et_r_k_t1+...   %2014/08/12 î—êØ
...
% Eq_S6 = -Et_r_E_t1 + r_n_t - Et_pi_t1 - mu_E*(n_t-q_t-k_t) + z_efp_t;  %2014/08/10 î—êØèCê≥

% Eq_S7 = -z_star/eta/r_E*n_t + (1+lambda_i)/n_k*...   %2014/08/10 î—êØèCê≥
...
%  Eq_F11 = -r_n_t + Et_r_n_t1a + eta_r; %Å@%2014/08/12Å@î—êØèCê≥
...
%% n.eq = 37
System_of_Eq = [Eq_S1; Eq_S2; Eq_S3;  Eq_S5; Eq_S8; Eq_S9; Eq_S10; ...                 %2014/08/12Å@î—êØèCê≥
%   [Eq_S1; Eq_S2; Eq_S3; Eq_S4; Eq_S5; Eq_S6; Eq_S7; Eq_S8; Eq_S9; Eq_S10; ...  
  Eq_S11; Eq_S12; Eq_S13; Eq_S14; Eq_S15; ...
  Eq_S16; Eq_S17; ...
  Eq_F1; Eq_F2; Eq_F3; Eq_F4; Eq_F5; ...                
%   Eq_F6; Eq_F7; Eq_F8; Eq_F9; Eq_F10; Eq_F11; ...       %2014/08/12Å@î—êØèCê≥
    Eq_F6; Eq_F7; Eq_F8; Eq_F9; Eq_F10; ...  
  Eq_P1; Eq_P2; Eq_P3; Eq_P4; Eq_P5; ...
  Eq_P6; Eq_P7; Eq_P8;  ...                        %2014/08/10Å@î—êØèCê≥ 
  Eq_I1; Eq_I2; Eq_I3];
...
ystr = {'Yt', 'Ct', 'It', 'Wt', 'Lt', 'Pt', 'Pi/Pt',...
        'R_nt', 'Yt/Ystar', 'Bt','Kt','Nt','Qt','R^E_t'};

  yyirf_total1  = zeros(nirf,nvar,nshock);  % 2014/08/10 í«â¡

T1_save = T1;  
  
for sh_ind = 1:2; %nshock
    
  figure('Name', 'Impulse Responses of Structual Shock' ); % 2014/08/10 èCê≥
% figure('Name',strcat(titlestr(sh_ind)) );

     % monetary accommodation
     if monetary_accommodation==1;
        T0(14,:)=0;   % ã‡óòÇÕ14î‘ñ⁄
     end   
    %  end of  monetary accommodation
    ...
    for t = 2:nirf        
       ...
       % monetary accommodation
       if (t <= 10)&(monetary_accommodation==1)
         T1(14,:)=0;   % ã‡óòÇÕ14î‘ñ⁄
       else
         T1= T1_save; 
       end  
       %  end of  monetary accommodation
        ...
        yyirf(t,5:nvar) = dyyirf(t,5:nvar);%2014.8.15íÜë∫èCê≥
        ss = ss1;
    end
   for j = 1:9
      subplot(3, 3, j); % 2014/08/10 í«â¡Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@
      plot(1:nirf, yyirf(:,j),'b')
      title(strcat(titlestr(sh_ind),ystr(j)))
   end
    
    yyirf_total1(:,:,sh_ind)  = yyirf;  % 2014/08/10 í«â¡
