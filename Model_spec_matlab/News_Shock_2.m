...
syms Et_z_z_t1 Et_z_z_t2   Et_z_z_t3 Et_z_z_t1a Et_z_z_t2a   Et_z_z_t3a epsilon_z_news  ...
     eta_z_z1 eta_z_z2 eta_z_z3 news_shock_t
% news_shock_t news_shock_t_lg1 news_shock_t_lg2  news_shock_t_lg3 ...
%      news_shock_ta news_shock_t_lga1 news_shock_t_lga2  news_shock_t_lga3 epsilon_z_news
...
%%  Endogenous Variables (38)  %2014/08/10 飯星修正
 Y_t = [c_t; lambda_t; w_t;  q_t;  r_k_t; u_t; ...   
     ...
     Et_z_b_t1; Et_z_psi_t1; Et_z_star_t1;...
     %% news shocks
     Et_z_z_t1; Et_z_z_t2; Et_z_z_t3 ];
%      news_shock_t; news_shock_t_lg1; news_shock_t_lg2     ];

%% Endogenous Variables(lagged) (38)  
Y_ta = [c_ta; lambda_ta; w_ta; q_ta;  r_k_ta; u_ta; ...
    ...
    %% new shocks
    Et_z_z_t1a; Et_z_z_t2a; Et_z_z_t3a ];
%     news_shock_ta; news_shock_t_lga1; news_shock_t_lga2    ];
...
%  Eq_F11 = -r_n_t + Et_r_n_t1a + eta_r; %　%2014/08/12　飯星修正

%% News Shock (Type 2)
Eq_F12 = - z_z_t + Et_z_z_t1a + eta_z_z1;
Eq_F13 = - Et_z_z_t1 + Et_z_z_t2a+eta_z_z2;
Eq_F14 = - Et_z_z_t2 + Et_z_z_t3a+eta_z_z3;
...
%% news shock (Type 2)
% Eq_P7 = -z_z_t + rho_z*z_z_ta + epsilon_z +  news_shock_t_lga2;
 Eq_P7 =-Et_z_z_t3 + rho_z*Et_z_z_t3a + epsilon_z_news;
...
%% News Shock
%  Eq_p11=  -news_shock_t + epsilon_z_news;
...
%% News Shock (Type 1)
% Eq_I4=  -news_shock_t_lg1 + news_shock_ta;
% Eq_I5=  -news_shock_t_lg2 + news_shock_t_lga1;


%% n.eq = 37
System_of_Eq = [Eq_S1; Eq_S2; Eq_S3;  Eq_S5; Eq_S8; Eq_S9; Eq_S10; ...               %2014/08/12　飯星修正
  Eq_S11; Eq_S12; Eq_S13; Eq_S14; Eq_S15; ...
  Eq_S16; Eq_S17; ...
%   Eq_S18; ...
  Eq_F1; Eq_F2; Eq_F3; Eq_F4; Eq_F5; ...                
    Eq_F6; Eq_F7; Eq_F8; Eq_F9; Eq_F10; ...
    Eq_F12; Eq_F13;  Eq_F14; ...
  Eq_P1; Eq_P2; Eq_P3; Eq_P4; Eq_P5; ...
  Eq_P6; Eq_P7; Eq_P8;  ...
%    Eq_p11; ...    % News Shocks
  Eq_I1; Eq_I2; Eq_I3; ...
  ];
%   Eq_I4; Eq_I5;];  % News Shocks
...
titlestr = {'Zb :', 'Zg :', 'Zw :', 'Zp :', 'Z_\nu :',...
            'Zr :', 'Zz :', 'Z_\phi :',  'News Shock :'};

ystr = {'Yt', 'Ct', 'It', 'Wt', 'Lt', 'Pt', 'Pi/Pt',...
        'R_nt', 'Yt/Ystar', 'Kt','Qt','R^E_t'};
