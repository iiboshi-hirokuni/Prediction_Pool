...
nvar   = 11;  % num of  observed variables
nshock = 10;
npara  = 39;
...
runname = 'm2011'
datafilename = 'kaihatsu_kurozumi_data.csv';
...
nburnin_block = 10;  % blocks for burn-in
nthin = 1;          % number of thining
 cc = 0.1;         % adjustment coefficient of random walk MH algorithm
